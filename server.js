...
app.use('/graphql', (req, res) => {
  ...
  return graphqlHTTP({
    schema,
    graphiql: { subscriptionEndpoint: env === 'production' ?  `wss://${req.header('host')}/subscriptions` : `ws://localhost:${port}/subscriptions` },
...
server.listen(port, () => {
  ...
  console.log(`subscription services running on ws://localhost:${port}/subscriptions`);
